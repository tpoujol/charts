...
actual class SimpleValueDrawer actual constructor(
    ...
    override fun drawLabel(
        ...
        val txLine = TextLine.make(label, Font(typeface = null, size = labelTextSize.toPx()))
        ...
        canvas.nativeCanvas.drawTextLine(txLine, xCenter, yCenter, paint.asFrameworkPaint())
        return@with
    }
}